...
__all__ = [
    'SPEI_VISEME', 'DISPID_SpeechMMSysAudio', 'SPWORD',
    'DISPID_SRGetFormat', 'DISPID_SRSClsidEngine', 'SPSHT_EMAIL',
    'DISPID_SOTsCount', 'DISPID_SWFEAvgBytesPerSec', 'SVP_11',
    'SVSFDefault', 'SAFT12kHz8BitMono', 'SVSFParseSapi',
    'DISPID_SVESentenceBoundary', 'SpCompressedLexicon',
    'SREHypothesis', 'DISPID_SPEAudioSizeBytes', 'SVP_10',
    'DISPID_SGRId', 'ISpObjectTokenCategory',
    'SGDSActiveUserDelimited', 'DISPID_SPPId', 'SpeechMicTraining',
    'SP_VISEME_21', 'DISPID_SLWType', 'SP_VISEME_0', 'SPLEXICONTYPE',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SLPSymbolic',
    'DISPID_SRCCreateResultFromMemory',
    'DISPID_SpeechPhraseAlternate', 'SAFTCCITT_ALaw_22kHzMono',
    'SECLowConfidence', 'SSFMCreateForWrite',
    'DISPID_SVWaitUntilDone', 'DISPID_SBSRead',
    'SpeechTokenKeyAttributes', 'SPEI_PROPERTY_NUM_CHANGE',
    'DISPID_SABufferInfo', 'DISPID_SPEDisplayAttributes',
    'DISPID_SRGReset', 'DISPID_SRGSetTextSelection',
    'DISPID_SRGDictationSetState', 'DISPID_SGRSTs_NewEnum',
    'SPSEMANTICFORMAT', 'SPEI_RECOGNITION', 'SPGS_DISABLED',
    'SpeechPropertyNormalConfidenceThreshold', 'DISPID_SPRText',
    'SECFEmulateResult', 'DISPID_SGRSTNextState',
    'SAFTADPCM_44kHzMono', 'SVP_1', 'DISPID_SRCRetainedAudio',
    'SPAUDIOBUFFERINFO', 'DISPID_SPRulesCount', 'eLEXTYPE_MORPHOLOGY',
    'SVSFNLPSpeakPunc', 'DISPID_SpeechObjectToken',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SVSInputWordLength',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SPRNumberOfElements',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SVEBookmark',
    'STSF_AppData', 'DISPID_SVSLastBookmark',
    'DISPID_SRCEStartStream', 'SpMMAudioIn', 'SITooLoud',
    'DISPID_SGRsFindRule', 'SPEI_RESERVED2',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SRIsUISupported',
    'ISpRecoContext2', 'DISPID_SVGetAudioInputs',
    'DISPID_SRCESoundEnd', 'SAFT16kHz16BitStereo',
    'SpPhraseInfoBuilder', 'ISpeechRecoResult2',
    'SPEI_SR_AUDIO_LEVEL', 'SPSHT_Unknown', 'DISPID_SpeechFileStream',
    'SASClosed', 'SAFT16kHz8BitStereo', 'SPEI_SENTENCE_BOUNDARY',
    'DISPID_SPPParent', 'SPBO_TIME_UNITS', 'SAFTCCITT_uLaw_8kHzMono',
    'SPPHRASEELEMENT', 'DISPID_SpeechPhraseBuilder',
    'ISpeechObjectToken', 'DISPID_SPEActualConfidence',
    'DISPID_SDKEnumValues', 'DISPID_SRCEEnginePrivate',
    'SPEI_MAX_TTS', 'SpeechStreamFileMode', 'SpInprocRecognizer',
    'DISPID_SRCEAudioLevel', 'DISPID_SGRSTPropertyName',
    'SpeechEngineProperties', 'DISPID_SVSkip', 'SGDSInactive',
    'DISPID_SPAsCount', 'DISPID_SLAddPronunciation',
    'SpeechGrammarState', 'SPRS_INACTIVE', 'SpMMAudioOut',
    'DISPID_SOTCId', 'DISPID_SVAudioOutput', 'DISPID_SAStatus',
    'SpeechEngineConfidence', 'ISpMMSysAudio', 'ISpeechRecoResult',
    'DISPID_SPPName', 'DISPID_SPARecoResult', 'SPSHORTCUTPAIRLIST',
    'ISpVoice', 'SpeechCategoryAudioOut',
    'DISPID_SLRemovePronunciation', 'DISPID_SPEDisplayText',
    'DISPIDSPTSI_ActiveOffset', 'SGSExclusive',
    'SPINTERFERENCE_LATENCY_WARNING', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'eLEXTYPE_VENDORLEXICON', 'SPSEMANTICERRORINFO',
    'SVEStartInputStream', 'ISpRecoContext', 'DISPID_SLPs_NewEnum',
    'eWORDTYPE_DELETED', 'DISPID_SGRSAddSpecialTransition',
    'SpeechGrammarTagDictation', 'SP_VISEME_17', 'SP_VISEME_18',
    'SVP_0', 'DISPID_SRCState', 'DISPID_SDKDeleteValue',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SWFEChannels',
    'SPLOADOPTIONS', 'ISpeechVoice', 'SpeechBookmarkOptions',
    'DISPID_SpeechVoiceStatus', 'ISpResourceManager',
    'DISPID_SVEEnginePrivate', 'DISPID_SOTRemoveStorageFileName',
    'ISpObjectWithToken', 'SREAllEvents', 'SPINTERFERENCE_NOSIGNAL',
    'SPCT_COMMAND', 'DISPID_SVSInputWordPosition', 'SP_VISEME_19',
    'SPAUDIOOPTIONS', 'eLEXTYPE_RESERVED10', 'SpeechAddRemoveWord',
    'ISpAudio', 'SPEI_VOICE_CHANGE', 'ISpeechMemoryStream',
    'eWORDTYPE_ADDED', 'DISPID_SRRTOffsetFromStart',
    'ISpeechPhraseProperties', 'DISPID_SASetState', 'DISPID_SRCVoice',
    'SAFTADPCM_44kHzStereo', 'DISPID_SRCAudioInInterferenceStatus',
    'ISpeechGrammarRuleStateTransition', 'SRERecognition',
    'SPPS_RESERVED4', 'DISPID_SAFGetWaveFormatEx',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SRCVoicePurgeEvent',
    'ISpDataKey', 'DISPID_SPPValue', 'SpeechPropertyAdaptationOn',
    'SSTTTextBuffer', 'SDTAlternates', 'LONG_PTR', 'ISpRecognizer2',
    'SAFT32kHz8BitStereo', 'SPWT_DISPLAY',
    'DISPID_SRSCurrentStreamPosition',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SVIsUISupported',
    'SAFTADPCM_22kHzStereo', 'DISPID_SGRsItem', 'SDTPronunciation',
    'SpeechGrammarTagUnlimitedDictation', 'SINone',
    'DISPID_SRCERequestUI', 'SAFTNoAssignedFormat',
    'DISPID_SRCResume', 'DISPID_SGRSTsCount', 'SPDKL_CurrentUser',
    'SpeechVisemeFeature', 'SAFTGSM610_22kHzMono', 'SPPS_RESERVED2',
    'DISPID_SMSGetData', 'SpeechGrammarTagWildcard',
    'DISPID_SOTsItem', 'DISPID_SAFGuid', 'IStream',
    'SpStreamFormatConverter', 'DISPID_SGRSTransitions',
    'SPEI_MIN_TTS', 'ISpeechTextSelectionInformation',
    'DISPID_SRCEventInterests', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SECNormalConfidence', 'DISPID_SGRSTText', 'SRAONone',
    'DISPID_SRGetPropertyNumber', 'eLEXTYPE_PRIVATE11',
    'DISPID_SRSSupportedLanguages', 'SPPS_NotOverriden',
    'SPWORDPRONUNCIATIONLIST', 'SDTReplacement', 'ISpeechLexiconWord',
    'SAFTGSM610_44kHzMono', 'SpeechCategoryAudioIn', 'DISPID_SRState',
    'SGRSTTWord', 'SAFTCCITT_ALaw_44kHzMono', 'SPAR_Low',
    'SGRSTTTextBuffer', 'SPRS_ACTIVE', 'tagSTATSTG',
    'SpeechRecoProfileProperties', 'SSFMCreate', 'SpeechTokenContext',
    'SPXRO_SML', 'SP_VISEME_11', 'DISPID_SpeechObjectTokenCategory',
    'DISPID_SCSBaseStream', 'SPEI_RESERVED5', 'SDTProperty',
    'Speech_Max_Word_Length', 'SpeechVoiceSpeakFlags', 'SVP_17',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SPEVENTENUM', 'ISpPhrase',
    'ISpeechAudioBufferInfo', 'SpeechAudioFormatGUIDText',
    'DISPID_SAFSetWaveFormatEx', 'STCInprocServer',
    'DISPID_SRCEFalseRecognition', 'DISPID_SPERequiredConfidence',
    'DISPID_SpeechPhraseRule', 'SVSFIsNotXML',
    'DISPID_SRCERecognition', 'DISPID_SpeechAudioFormat',
    'eLEXTYPE_PRIVATE1', 'WAVEFORMATEX',
    'SpPhoneticAlphabetConverter', 'DISPID_SRCEAdaptation',
    'DISPID_SLPsCount', 'SAFT32kHz8BitMono', 'SECFDefault',
    'eLEXTYPE_RESERVED6', 'DISPID_SRGRecoContext',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SPIAudioSizeBytes',
    'SPSERIALIZEDPHRASE', 'SPGRAMMARWORDTYPE', 'ISpStream',
    'SRAORetainAudio', 'SAFT11kHz16BitStereo', 'SPWORDTYPE',
    'DISPID_SWFEExtraData', '_SPAUDIOSTATE', 'SPSHT_NotOverriden',
    'DISPID_SpeechAudio', 'SpeechEmulationCompareFlags',
    'DISPID_SRGIsPronounceable', 'DISPID_SRCEEndStream',
    'SPEI_PHONEME', 'SpNotifyTranslator', 'ISpRecognizer3',
    'DISPID_SLWsCount', 'SFTSREngine', 'DISPID_SOTCGetDataKey',
    'DISPID_SpeechVoice', 'DISPID_SGRName',
    'DISPID_SRGCmdLoadFromMemory', 'SpeechInterference',
    'SpPhoneConverter', 'ISpRecognizer', 'SRTSMLTimeout',
    'DISPID_SpeechDataKey', 'SVP_21', 'DISPID_SOTCreateInstance',
    'DISPID_SPEPronunciation', 'SRESoundStart', 'IEnumString',
    'SGLexicalNoSpecialChars', 'DISPID_SLWs_NewEnum', 'SRAImport',
    'SPWF_INPUT', 'SPAS_STOP', 'ISpProperties',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SVP_20',
    'DISPID_SpeechCustomStream', 'DISPID_SRCRecognizer',
    'SPFM_NUM_MODES', 'SSTTWildcard', 'SAFT32kHz16BitMono', 'SVP_8',
    'DISPID_SRRTTickCount', 'DISPID_SPEEngineConfidence',
    'SpeechRecognizerState', 'DISPID_SGRs_NewEnum', 'SPAUDIOSTATE',
    'ISpeechRecoContext', 'SPCT_SLEEP', 'SRARoot', 'SVSFParseSsml',
    'SAFTADPCM_22kHzMono', 'SPRST_NUM_STATES', 'SPPS_RESERVED3',
    'SPGS_ENABLED', 'SREStreamStart', 'SAFT44kHz16BitStereo',
    'SWPKnownWordPronounceable', 'SGDSActiveWithAutoPause',
    'SRSEDone', 'DISPID_SGRSRule', 'SAFTCCITT_ALaw_8kHzStereo',
    'SVSFParseMask', 'SREAdaptation', 'DISPID_SPCPhoneToId',
    'SAFT11kHz16BitMono', 'ISpeechAudioStatus',
    'DISPID_SPIAudioSizeTime', 'ISpSerializeState', 'SGRSTTWildcard',
    'SPPHRASEREPLACEMENT', 'SAFT22kHz16BitMono',
    'SpeechVoiceCategoryTTSRate', 'SPAR_Unknown',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SGRSTRule',
    'SREAudioLevel', 'SP_VISEME_16', 'SDKLLocalMachine',
    'DISPID_SLGetGenerationChange', 'SAFT12kHz16BitMono',
    'DISPID_SVEStreamStart', 'SPRECORESULTTIMES', 'SRAExport',
    'SpeechCategoryRecognizers', 'DISPID_SRCEBookmark',
    'SPEI_START_INPUT_STREAM', 'SAFT11kHz8BitStereo', 'SP_VISEME_1',
    'SGDisplay', 'ISpeechBaseStream',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SPLO_STATIC',
    'DISPID_SPRulesItem', 'SpeechRunState', 'SPEI_TTS_AUDIO_LEVEL',
    'SPEVENT', 'SPWAVEFORMATTYPE', 'DISPID_SpeechRecoResult2',
    'SVPNormal', 'SAFTGSM610_11kHzMono', 'ISpGrammarBuilder',
    'eLEXTYPE_PRIVATE9', 'DISPID_SVStatus', 'SP_VISEME_15',
    'DISPID_SVAudioOutputStream', 'SAFT12kHz8BitStereo',
    'SpeechPartOfSpeech', 'SP_VISEME_7', 'SPAUDIOSTATUS',
    'DISPID_SVEventInterests', 'SVP_12', 'SPEI_END_SR_STREAM',
    'DISPID_SpeechPhraseInfo', 'DISPID_SRCEInterference',
    'DISPID_SFSOpen', 'DISPID_SpeechLexiconWords',
    'IEnumSpObjectTokens', 'SFTInput', 'DISPID_SPEsCount',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SPRuleConfidence',
    'DISPID_SLWPronunciations', 'ISpRecoResult',
    'DISPID_SGRSTPropertyId', 'DISPID_SPEAudioSizeTime',
    'DISPID_SVSLastStreamNumberQueued', 'SPSModifier',
    'SAFT16kHz16BitMono', 'SREPrivate', 'SPPS_Noncontent',
    'SAFTExtendedAudioFormat', 'SECFIgnoreKanaType',
    'SPEI_TTS_BOOKMARK', 'DISPID_SLPPhoneIds', 'SAFTADPCM_8kHzStereo',
    'SAFT48kHz8BitMono', 'SPSHORTCUTTYPE', 'SAFT48kHz16BitStereo',
    'SAFTADPCM_11kHzMono', 'DISPID_SVGetProfiles',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SGRAttributes', 'UINT_PTR',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SRRGetXMLResult',
    'ISpeechPhraseAlternates', 'SAFT16kHz8BitMono',
    'DISPID_SLWLangId', 'DISPID_SDKSetStringValue',
    'ISpPhoneticAlphabetConverter', 'DISPID_SRDisplayUI',
    'SPRECOSTATE', 'SREInterference', 'ISpeechWaveFormatEx',
    'DISPID_SPAStartElementInResult', 'ISpObjectToken',
    'SpeechTokenShellFolder', 'ISpNotifySink', 'SWTDeleted',
    'DISPID_SGRsAdd', 'DISPID_SOTId', 'DISPID_SpeechRecoContext',
    'SAFTCCITT_uLaw_11kHzStereo', 'ISpeechGrammarRules',
    'SPEVENTSOURCEINFO', 'ISpeechResourceLoader', 'DISPID_SRCPause',
    'SPRST_INACTIVE_WITH_PURGE', 'SpObjectTokenCategory',
    'ISpeechLexicon', 'SpeechUserTraining', 'eLEXTYPE_PRIVATE15',
    'DISPID_SVResume', 'SLODynamic',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SOTCategory',
    'SGLexical', 'SGRSTTDictation', 'DISPID_SRRTLength',
    'DISPID_SLWWord', 'DISPID_SVPause', 'ISpPhoneConverter',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SpeechAudioState',
    'DISPID_SGRSTWeight', 'DISPID_SGRSTType', 'SpNullPhoneConverter',
    'SVSFIsXML', 'STCInprocHandler', '_ISpeechVoiceEvents',
    'SP_VISEME_10', 'SRTReSent', 'DISPID_SVSCurrentStreamNumber',
    'SpInProcRecoContext', 'DISPID_SOTCEnumerateTokens',
    'eLEXTYPE_PRIVATE19', 'DISPID_SPELexicalForm',
    'DISPID_SRIsShared', 'ISpeechMMSysAudio',
    'ISpeechLexiconPronunciation', 'DISPID_SPRules_NewEnum',
    'DISPID_SPAsItem', 'SAFTCCITT_uLaw_8kHzStereo', 'SPPS_Unknown',
    'DISPID_SpeechVoiceEvent', 'SpeechWordType', 'SREStateChange',
    'DISPID_SpeechPhraseAlternates', 'ISpLexicon', 'SRATopLevel',
    'DISPID_SPIStartTime', 'SRADefaultToActive',
    'SpeechGrammarWordType', 'ISpeechLexiconWords',
    'ISpeechGrammarRuleState', 'DISPID_SVSpeakCompleteEvent',
    'SAFTGSM610_8kHzMono', 'SpeechRegistryUserRoot', 'SPPHRASE',
    'SPINTERFERENCE_TOOSLOW', 'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SpeechObjectTokens', 'ISpeechPhoneConverter',
    'SPVPRIORITY', 'DISPID_SDKGetlongValue',
    'ISpeechPhraseReplacements', 'eLEXTYPE_PRIVATE4',
    'DISPID_SpeechPhraseReplacement', 'SVF_Emphasis', 'SPAS_PAUSE',
    'SDTAudio', 'DISPID_SWFEBitsPerSample', 'eLEXTYPE_PRIVATE18',
    'SPSTREAMFORMATTYPE', 'SPPS_SuppressWord', 'SINoise',
    'DISPID_SOTRemove', 'SPDKL_CurrentConfig', 'SGDSActive',
    'SRADynamic', 'SpeechVoiceSkipTypeSentence',
    'SAFTCCITT_uLaw_11kHzMono', 'SWPUnknownWordPronounceable',
    'ISpRecoCategory', 'SAFT44kHz8BitMono',
    'DISPID_SPIEnginePrivateData', 'SDKLCurrentConfig',
    'SPPROPERTYINFO', 'SAFTCCITT_ALaw_11kHzStereo',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SAFT24kHz16BitStereo',
    '_ISpeechRecoContextEvents', 'SPEI_WORD_BOUNDARY', 'SPAS_CLOSED',
    'SPSMF_UPS', 'SVEViseme', 'DISPID_SRGRules', 'SpLexicon',
    'DISPID_SPANumberOfElementsInResult', 'SDTAll',
    'DISPID_SOTCSetId', 'eLEXTYPE_RESERVED8',
    'DISPID_SRCEPhraseStart', 'DISPID_SOTGetAttribute',
    'SAFT24kHz8BitMono', 'SPEI_SOUND_START', 'SREPhraseStart',
    'ISpRecoGrammar', 'SpWaveFormatEx',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'ISpeechRecoResultTimes', 'DISPID_SRGState', 'tagSPPROPERTYINFO',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SDKEnumKeys',
    'DISPID_SpeechAudioStatus', 'SPRS_ACTIVE_USER_DELIMITED',
    'DISPID_SOTDataKey', 'SPAR_High', 'DISPID_SVSPhonemeId',
    'SPVISEMES', 'DISPID_SAEventHandle', 'DISPID_SABIMinNotification',
    'SpeechRuleState', 'DISPID_SRRAudio', 'ISpeechPhraseInfo',
    'SREFalseRecognition', 'SVP_2', 'SDA_No_Trailing_Space',
    'DISPID_SOTSetId', 'DISPID_SRCCmdMaxAlternates',
    'SPBOOKMARKOPTIONS', 'SITooSlow', 'DISPID_SRRPhraseInfo',
    'SSTTDictation', 'SRTEmulated', 'DISPID_SpeechLexiconWord',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SRSEIsSpeaking',
    'SRSInactiveWithPurge', 'eLEXTYPE_PRIVATE12',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SPRDisplayAttributes',
    'DISPID_SPRuleFirstElement', 'SAFTCCITT_uLaw_22kHzMono',
    'SP_VISEME_5', 'SPLO_DYNAMIC', 'SpeechCategoryRecoProfiles',
    'eLEXTYPE_PRIVATE8', 'SAFT48kHz8BitStereo', 'ISpeechCustomStream',
    'SPFM_CREATE_ALWAYS', 'DISPID_SRRecognizer', 'SpeechRecoEvents',
    'DISPID_SRGDictationLoad', 'DISPID_SPRFirstElement',
    'DISPID_SRAudioInput', 'SDTDisplayText', 'ISpNotifySource',
    'DISPID_SADefaultFormat', 'ISpeechAudioFormat',
    'SpTextSelectionInformation', 'DISPID_SRGCmdLoadFromFile',
    'eLEXTYPE_USER_SHORTCUT', 'SPWORDPRONOUNCEABLE',
    'ISpXMLRecoResult', 'SPRECOCONTEXTSTATUS', 'DISPID_SPRsCount',
    'SpResourceManager', 'DISPID_SDKDeleteKey', 'ISpPhraseAlt',
    'DISPID_SRAudioInputStream', 'DISPID_SRRTimes', 'SVP_14',
    'SP_VISEME_13', 'DISPIDSPTSI_SelectionLength',
    'DISPID_SPPFirstElement', 'SPPS_Modifier',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SVEAudioLevel',
    'eLEXTYPE_PRIVATE13', 'SVSFPurgeBeforeSpeak',
    'DISPID_SRRSpeakAudio', 'DISPID_SPIEngineId',
    'DISPID_SLGenerationId', 'SAFT22kHz16BitStereo', 'SPSFunction',
    'eLEXTYPE_PRIVATE7', 'DISPID_SPIRule', 'SPTEXTSELECTIONINFO',
    'SpeechCategoryVoices', 'SAFTADPCM_8kHzMono', 'SREStreamEnd',
    'SpeechVisemeType', 'DISPID_SBSFormat', 'eLEXTYPE_RESERVED9',
    'DISPID_SPRuleChildren', 'DISPID_SAVolume',
    'DISPID_SRGetPropertyString', 'SPVPRI_ALERT', 'DISPID_SMSSetData',
    'DISPID_SpeechXMLRecoResult', 'SVEPrivate', 'ISpeechVoiceStatus',
    'SpeechAudioVolume', 'DISPID_SPPBRestorePhraseFromMemory',
    'SPVPRI_NORMAL', 'SAFT48kHz16BitMono', 'SRSActiveAlways',
    'SPEI_REQUEST_UI', 'SPCT_SUB_COMMAND', 'SGSDisabled',
    'DISPID_SVSpeakStream', 'SpeechGrammarRuleStateTransitionType',
    'ISpeechAudio', 'DISPID_SPRuleParent', 'SVSFNLPMask',
    'SPXMLRESULTOPTIONS', 'ISpeechPhraseRule', 'DISPID_SPRsItem',
    'SVEPhoneme', 'SASPause', 'DISPID_SPCIdToPhone',
    'ISpRecoGrammar2', 'DISPID_SRGetRecognizers',
    'DISPID_SpeechRecoContextEvents', 'SPWT_PRONUNCIATION',
    'SVEAudioLevel', 'SpeechAllElements', 'DISPID_SPAPhraseInfo',
    'SRSInactive', 'SpStream', 'SINoSignal', 'eLEXTYPE_PRIVATE14',
    'DISPID_SRStatus', 'eLEXTYPE_USER', 'SP_VISEME_6',
    ...
    'DISPID_SpeechGrammarRule', 'DISPID_SPRs_NewEnum',
    'DISPID_SpeechRecognizerStatus', 'SLOStatic', 'SITooFast',
    'SPEI_END_INPUT_STREAM', 'SpMemoryStream', 'SAFTDefault', 'SVP_3',
    'DISPID_SGRSTPropertyValue', 'SpeechPropertyResourceUsage',
    'DISPID_SMSALineId', 'SRSActive', 'DISPIDSPTSI', 'SPVOICESTATUS',
    'SDKLCurrentUser', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SPRuleName', 'SVP_6', 'DISPID_SpeechBaseStream',
    'DISPID_SLPsItem', 'Speech_StreamPos_Asap', 'DISPID_SPPChildren',
    'DISPID_SpeechMemoryStream', 'DISPID_SpeechPhraseReplacements',
    'DISPID_SLGetPronunciations', 'SPRULE', 'eLEXTYPE_RESERVED4',
    'STCAll', 'tagSPTEXTSELECTIONINFO',
    'DISPID_SpeechLexiconPronunciation', 'SpeechCategoryAppLexicons',
    'SPPARTOFSPEECH', 'SPAO_NONE', 'SAFT22kHz8BitStereo',
    'STSF_FlagCreate', 'SASRun', 'STSF_CommonAppData',
    'DISPID_SGRsCommitAndSave', 'SPGS_EXCLUSIVE', 'SpObjectToken',
    'DISPID_SBSWrite', 'SpeechTokenIdUserLexicon',
    'SpeechAudioProperties', 'ISpeechRecognizer', 'SSFMOpenForRead',
    'ISpeechPhraseProperty', 'SP_VISEME_12', 'SPSHT_OTHER',
    'SVEEndInputStream', 'DISPID_SVEStreamEnd',
    'ISpeechPhraseInfoBuilder', 'DISPID_SFSClose', 'SPPHRASEPROPERTY',
    'SPEI_PROPERTY_STRING_CHANGE', 'SVP_4', 'eLEXTYPE_APP',
    'DISPID_SVGetAudioOutputs', 'SVF_Stressed', 'eLEXTYPE_PRIVATE10',
    'SPDKL_DefaultLocation', 'SP_VISEME_3', 'DISPID_SpeechRecognizer',
    'SAFT22kHz8BitMono',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SGRSAddWordTransition', 'DISPID_SOTDisplayUI',
    'SPCS_ENABLED', 'SAFT8kHz16BitStereo', 'SPEI_RESERVED1',
    'DISPID_SPIElements', 'SPINTERFERENCE_TOOQUIET',
    'SAFT44kHz16BitMono', 'DISPID_SPIAudioStreamPosition',
    'DISPID_SLPPartOfSpeech', 'DISPID_SPILanguageId', 'SPCS_DISABLED',
    'DISPID_SLPLangId', 'SLTApp', 'SPSERIALIZEDRESULT',
    'SVSFVoiceMask', 'DISPID_SRCRetainedAudioFormat', 'SGSEnabled',
    'SPEI_PHRASE_START', 'SPEI_SR_BOOKMARK',
    'DISPID_SpeechPhraseRules', 'SAFTCCITT_ALaw_8kHzMono',
    'SPSHORTCUTPAIR', 'DISPID_SPPs_NewEnum', 'eLEXTYPE_PRIVATE6',
    'DISPID_SOTMatchesAttributes', 'SAFT24kHz8BitStereo',
    'SpeechRegistryLocalMachineRoot', 'SpeechVoiceEvents',
    'SPCONTEXTSTATE', 'DISPID_SpeechWaveFormatEx', 'SITooQuiet',
    'Speech_StreamPos_RealTime', 'SPAR_Medium', 'SPBO_NONE',
    'ISpStreamFormatConverter', 'DISPID_SDKSetLongValue',
    'SPDKL_LocalMachine', 'DISPID_SASNonBlockingIO',
    'DISPID_SPRuleId', '__MIDL_IWinTypes_0009', 'SP_VISEME_20',
    'SPRULESTATE', 'DISPID_SRSetPropertyString', 'DISPID_SBSSeek',
    'DISPID_SDKOpenKey', 'DISPID_SPIReplacements',
    'ISpeechLexiconPronunciations', 'SDTRule', 'SpeechTokenKeyFiles',
    'ISpeechPhraseReplacement', 'SpeechDictationTopicSpelling',
    'DISPID_SVRate', 'SWPUnknownWordUnpronounceable',
    'ISpeechDataKey', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SRESoundEnd', 'SVF_None', 'SSSPTRelativeToEnd',
    'DISPID_SOTGetDescription', 'SECFIgnoreCase',
    'SAFTADPCM_11kHzStereo', 'DISPID_SVSpeak', 'STSF_LocalAppData',
    'SDA_One_Trailing_Space', 'SVPOver', 'SPCATEGORYTYPE',
    'DISPID_SVPriority', 'SP_VISEME_8', 'SVESentenceBoundary',
    'DISPID_SPEsItem', 'DISPID_SPPConfidence', 'SECFIgnoreWidth',
    'SECFNoSpecialChars', 'SPEI_SOUND_END', 'SLTUser',
    'DISPID_SRCESoundStart', 'ISequentialStream',
    'DISPID_SRRRecoContext', 'SPPS_Verb', 'SpeechDiscardType',
    'ISpEventSource', 'SBONone', 'SGPronounciation',
    'SPBINARYGRAMMAR', 'SSFMOpenReadWrite', 'ISpeechRecoGrammar',
    'ISpeechGrammarRuleStateTransitions', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SRRAlternates', 'SRCS_Enabled', 'SPRST_INACTIVE',
    'SPFM_OPEN_READWRITE', 'SpeechFormatType', 'SpMMAudioEnum',
    'DISPIDSPRG', 'DISPID_SPERetainedStreamOffset',
    'DISPID_SpeechLexicon', 'DISPID_SVDisplayUI', 'SpVoice',
    'DISPID_SpeechGrammarRules', 'SPSNoun', 'DISPID_SPISaveToMemory',
    'SRERequestUI', 'DISPID_SPIProperties', 'SPEI_RECO_OTHER_CONTEXT',
    'DISPID_SRRAudioFormat', 'SPFILEMODE', 'DISPID_SRSAudioStatus',
    'DISPID_SWFEBlockAlign', 'DISPID_SVSInputSentenceLength',
    'SWTAdded', 'eLEXTYPE_PRIVATE3', 'SPEI_RESERVED3',
    'SpCustomStream', 'SSSPTRelativeToCurrentPosition',
    'DISPID_SGRAddState', 'DISPID_SASState',
    'DISPID_SRGCmdSetRuleIdState', 'DISPID_SpeechPhraseElements',
    'IInternetSecurityManager', 'DISPID_SRCRequestedUIType',
    'SAFT24kHz16BitMono', '_RemotableHandle', 'DISPID_SPPsItem',
    'SPAO_RETAIN_AUDIO', 'SPINTERFERENCE_TOOFAST',
    'SPCT_SUB_DICTATION', 'DISPID_SASFreeBufferSpace',
    'DISPID_SRCreateRecoContext', 'DISPID_SRSNumberOfActiveRules',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SP_VISEME_9', 'SAFT8kHz8BitStereo',
    'SpeechLoadOption', 'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SRCBookmark', 'ISpeechPhraseRules', 'SPEI_ADAPTATION',
    'SPSMF_SAPI_PROPERTIES', 'SPPS_Function',
    'DISPID_SGRInitialState', 'DISPID_SRRSaveToMemory',
    'SDTLexicalForm', 'DISPID_SRGId', 'SPSVerb',
    'SPRST_ACTIVE_ALWAYS', 'SpShortcut', 'DISPID_SAFType',
    'DISPID_SVGetVoices', 'DISPID_SRSetPropertyNumber',
    'SVSFParseAutodetect', 'ISpShortcut', 'eLEXTYPE_RESERVED7',
    'SVPAlert', 'SAFT11kHz8BitMono', 'SAFT32kHz16BitStereo',
    'ISpeechObjectTokenCategory', 'DISPIDSPTSI_SelectionOffset',
    'SPSInterjection', 'SpeechRuleAttributes', 'SDKLDefaultLocation',
    'SRCS_Disabled', 'SPINTERFERENCE_NONE', 'DISPID_SVAlertBoundary',
    'SVSFIsFilename', 'DISPID_SOTIsUISupported',
    ...
    'SPEI_MAX_SR', 'SASStop', 'SREPropertyStringChange',
    'SECHighConfidence', 'SBOPause', 'DISPID_SPACommit',
    'DISPID_SDKGetBinaryValue', 'ISpPhoneticAlphabetSelection',
    'SPSLMA', 'SpeechCategoryPhoneConverters',
    'DISPID_SABIBufferSize', 'SPFM_CREATE', 'SPFM_OPEN_READONLY',
    'SAFT8kHz8BitMono',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SPRECOGNIZERSTATUS', 'SPBO_AHEAD', 'SPEI_UNDEFINED',
    'SPGRAMMARSTATE', 'SVSFlagsAsync', 'eLEXTYPE_PRIVATE20',
    'DISPID_SGRsCommit', 'SPPS_RESERVED1', 'DISPID_SWFESamplesPerSec',
    'DISPID_SpeechAudioBufferInfo',
    'DISPID_SRCERecognizerStateChange', 'SRTAutopause', 'SGRSTTRule',
    'SSSPTRelativeToStart', 'SPEI_START_SR_STREAM',
    'DISPID_SDKGetStringValue', 'eLEXTYPE_PRIVATE16',
    'DISPID_SpeechLexiconProns', 'DISPID_SVSInputSentencePosition',
    'ISpeechPhraseElement', 'DISPID_SVVoice', 'ISpNotifyTranslator',
    'SpeechTokenKeyUI', 'SpUnCompressedLexicon', 'SPSSuppressWord',
    'SpeechVoicePriority', 'SVEAllEvents', 'ISpeechRecognizerStatus',
    'DISPID_SGRsDynamic', 'SVP_16', 'DISPID_SABufferNotifySize',
    'DISPID_SVEWord', 'SVEVoiceChange', 'SAFT44kHz8BitStereo',
    'DISPID_SRGCommit', 'DISPID_SGRSAddRuleTransition',
    'SpeechLexiconType', 'Speech_Default_Weight',
    'DISPID_SPIGetDisplayAttributes', 'SP_VISEME_14',
    'SpSharedRecognizer', 'DISPID_SLRemovePronunciationByPhoneIds',
    'SPEI_RESERVED6', 'DISPID_SGRClear', 'DISPID_SPPsCount',
    'SAFTText', 'SVEWordBoundary', 'DISPID_SGRSTsItem',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SRGDictationUnload',
    'SPINTERFERENCE_NOISE', 'DISPID_SRCCreateGrammar',
    'ISpeechGrammarRule', 'SPAS_RUN', 'SpeechWordPronounceable',
    'SPWORDLIST', 'ISpeechFileStream', 'SPVPRI_OVER',
    'SpeechRecognitionType', 'SRERecoOtherContext',
    'SAFTCCITT_ALaw_22kHzStereo', 'ISpeechXMLRecoResult',
    'SPWF_SRENGINE', 'SpeechRecoContextState', 'SVP_15',
    'SPEI_SR_PRIVATE', 'SVEBookmark', 'DISPID_SGRAddResource',
    'DISPID_SVSVisemeId', 'SPSNotOverriden', 'SpeechAudioFormatType',
    'DISPID_SVSRunningState', 'DISPID_SMSAMMHandle',
    'ISpeechObjectTokens', 'STCLocalServer',
    'DISPID_SDKSetBinaryValue', 'ISpeechPhraseElements',
    'SpeechSpecialTransitionType', 'SVSFPersistXML',
    'DISPID_SOTGetStorageFileName', 'eLEXTYPE_PRIVATE5',
    'SPEI_FALSE_RECOGNITION', 'SPWT_LEXICAL', 'DISPID_SPIGrammarId',
    'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SRCSetAdaptationData', 'DISPID_SRProfile',
    'SAFT12kHz16BitStereo', 'SPPS_Noun', 'SPADAPTATIONRELEVANCE',
    'Speech_Max_Pron_Length', 'SPINTERFERENCE', 'eLEXTYPE_PRIVATE17',
    'SVP_9', 'SDA_Two_Trailing_Spaces', 'SGRSTTEpsilon',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SGRsCount', 'SPCT_DICTATION',
    'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SPPS_LMA',
    'DISPID_SPCLangId', 'DISPID_SRRGetXMLErrorInfo', 'SP_VISEME_4',
    'ISpeechPhraseAlternate', 'DISPID_SpeechPhoneConverter',
    'DISPID_SREmulateRecognition', 'DISPID_SRRTStreamTime',
    'DISPID_SASCurrentDevicePosition', 'SPEI_RECO_STATE_CHANGE',
    'DISPID_SOTCDefault', 'DISPID_SpeechRecoResult',
    'DISPID_SPAs_NewEnum', 'SPINTERFERENCE_TOOLOUD',
    'SAFT8kHz16BitMono', 'SPWORDPRONUNCIATION',
    'DISPID_SRCEHypothesis', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SLWsItem', 'SRTStandard', 'SAFTCCITT_ALaw_11kHzMono',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SVVolume',
    'SpeechAudioFormatGUIDWave', 'SpAudioFormat',
    'DISPID_SpeechPhraseProperty', 'DISPID_SLGetWords',
    'DISPID_SPIGetText', 'SP_VISEME_2', 'DISPID_SVSLastResult',
    'DISPID_SPPNumberOfElements', 'SPEI_TTS_PRIVATE',
    'ISpStreamFormat', 'SpeechDisplayAttributes',
    'DISPID_SWFEFormatTag', 'SpFileStream',
    'DISPID_SPERetainedSizeBytes', 'SpeechStreamSeekPositionType',
    'SVP_18', 'DISPID_SVEVoiceChange', 'SpeechDataKeyLocation',
    'SAFTNonStandardFormat', 'SPRST_ACTIVE', 'SPPS_Interjection',
    'DISPID_SDKCreateKey', 'SRAInterpreter',
    'DISPID_SRCEPropertyNumberChange', 'SPSUnknown',
    'SPXRO_Alternates_SML', 'DISPID_SRRSetTextFeedback',
    'STCRemoteServer', 'DISPID_SpeechPhraseProperties',
    'DISPID_SABIEventBias', 'DISPID_SVEViseme', 'SVP_7',
    'ISpEventSink', 'DISPID_SPEAudioStreamOffset',
    'SpeechTokenValueCLSID', 'SPEI_MIN_SR', 'SVP_19',
    'SDA_Consume_Leading_Spaces', 'DISPID_SLPType',
    'DISPID_SRSCurrentStreamNumber', 'DISPIDSPTSI_ActiveLength',
    'SPDATAKEYLOCATION', 'SPPHRASERULE', 'DISPID_SOTs_NewEnum',
    'SREPropertyNumChange', 'SPBO_PAUSE', 'SVSFUnusedFlags',
    'DISPID_SMSADeviceId', 'DISPID_SPEs_NewEnum',
    'SpeechRetainedAudioOptions', 'SRTExtendableParse', 'SVP_13',
    'IInternetSecurityMgrSite', 'SVP_5', 'DISPID_SVEPhoneme',
    'SpSharedRecoContext'
]

_check_version('1.2.0', 1642442239.632512)
